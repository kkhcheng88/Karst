...
class DailyBenchTests(unittest.TestCase):
    def test_every_phase_is_reported_and_the_daily_path_is_restored(self):
        originals = (daily._save_run, service.plan_update, bars.series_from_evidence)
        ...
        self.assertEqual(originals, (daily._save_run, service.plan_update, bars.series_from_evidence))
