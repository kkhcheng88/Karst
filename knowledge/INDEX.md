...
|---|---|---|---|---|---|---|---|---|---|---|
| `aschenbrenner-situational` | book | Situational Awareness: The Decade Ahead(Leopold Aschenbrenner) | 2024 | 高 | 低 | 低 | 低 | ③④、共識、換類 | 敘事要釘死在可證錯的數字上;敘事成真時錢先落在物理瓶頸,不落在主角 | distilled |
| `chancellor-capital-returns` | book | Capital Returns(Edward Chancellor 編,Marathon) | 2015(樣本 2002–2015) | 中 | 低 | 高 | 低 | ①②③、換類、護城河 | 決定行業回報的是供給側資本流向,不是需求增長 | distilled |
| `dorsey-little-book` | book | The Little Book That Builds Wealth / 巴菲特的護城河(Pat Dorsey) | 2004 | 中 | 低 | 中 | 高 | ①②、護城河、定價 | 護城河只有四種結構來源,其餘看似優勢的都會被競爭拉回均值 | distilled |
| `freeman-shor-art-of-execution` | book | The Art of Execution(Lee Freeman-Shor) | 2015(樣本 2006–2013) | 中 | 高 | 中 | 中 | 全類、治理 | 命中率只有五成,勝負全在輸的注與贏的注怎樣處理 | distilled |
| `greenblatt-genius` | book | You Can Be a Stock Market Genius(Joel Greenblatt) | 1997(樣本 1980s 中–1996) | 中 | 中 | 高 | 高 | ①、事件窗、治理 | 錯價來自一群因與生意無關的理由而必須賣的賣家,他們是誰全部寫在申報裡 | distilled |
| `lynch-beating-street` | book | Beating the Street(Peter Lynch) | 1993 | 低 | 低 | 高 | 低 | ①②、定價、換類 | 選股靠腳走出來,每半年重核一次故事 | distilled |
...
| slug | 類型 | 標題(人物) | 年代 | 時代 | 期限 | 實踐 | 資本 | 對應注類 | 一句結論 | 狀態 |
|---|---|---|---|---|---|---|---|---|---|---|
...
| slug | 類型 | 標題(來源) | 年代 | 時代 | 期限 | 實踐 | 資本 | 對應注類 | 一句結論 | 狀態 |
|---|---|---|---|---|---|---|---|---|---|---|
| `royalflush-discord` | community | royalflush Discord(皇者順 888) | 2023–2026 | 高 | 中 | 高 | 中 | 全類、治理、事件窗 | 四年唯一貫穿的信條是倉位管理:寧願少賺也不要虧錢 | distilled |
...
| `meatbonetea` | social | 金融肉骨茶 Ivan Li(Facebook 專頁) | 2023–2026(四個年末切片) | 高 | 低 | 中 | 高 | ①、治理 | 一類注唯一的長期實踐者:買了就坐、不止蝕,而優勢來源就是時間本身 | 已蒸餾(四年只讀約 56 天,窗口外整段缺) |
| `alexmokinvest` | social | Alex Mok 美股策略研究(Facebook 專頁) | 2024–2026(三個年末切片) | 高 | 中 | 中 | 高 | ②③、事件窗、治理 | 一係買強勢,一係買恐慌,中間留力;早減好過遲減,遲減衰過不減 | 已蒸餾(三年只讀約 156 天,窗口外整段缺) |

## 五、備註

- 往績可查度不入本表欄位,留在各來源檔頭部的 `verified_record`;查權重爭議時要一併看那一欄(例如 `mw-stock` 有一位受訪者其後涉基金估值造假訴訟)。
- 「對應注類」欄各來源檔頭部目前兩套寫法並存(①②③④ 與 `pricing-position` 一類的英文控制詞彙),本表統一用中文簡寫;來源檔本身未改,日後整理時再收斂。
