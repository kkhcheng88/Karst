...
3. **開票**必掛 Epic `根基重整`(D-177)之下四件交付品之一(D09 資料 / D10 策略正本 / D11 ②收尾與回歸集 / D12 關鍵元素探索);Kira 把關會擋掛錯的。舊 Epic `方法論期(D-166)` 不再開票。
...
8. **主 agent 是顧問不是工頭**(用戶 2026-09-13):策略與形態親自思考並帶立場,回覆先講立場與對盤數的意義,不報機械過程。
