...
> **現行產品入口(D-181)**:策略正本為 `strategy/投資決策模型.md`(v1.1),委託 v1.2、六層 v1.3,設計與工作包見 `strategy/specs/獨立投研工作台設計與交付計劃-v1.md`。先交通用獨立股票頁;基本面推導當日內在價值,期限目標另有橋接。研究不讀私人或模型帳本,相位服務條件判斷,四類注不強制。原84宗按凍結協議保存。
>
