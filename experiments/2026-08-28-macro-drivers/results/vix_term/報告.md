...
- 跑法:共 30 格,其中 30 格今次真的動過引擎、0 格是讀回已有的運行(同一格不重跑);耗時 6.0 秒
...
- **單點最優**:threshold=1.05、tilt=1、cadence=monthly;annual_excess:SPY = 0.0064,鄰域平均 0.0017(落差 0.0047,普通),成交 74 筆,運行編號 run-952ddfbebb5e046b
- **鄰域平均最高**:threshold=1.1、tilt=1、cadence=monthly;鄰域平均 0.0043,本格 0.0063(山脊),運行編號 run-5e256f3ce1111a78
...
|---|---|---|---|---|---|---|---|
| 1 | threshold=1.05、tilt=1、cadence=monthly | 0.0064 | 0.0017 | 0.0047 | 普通 | 74 | run-952ddfbebb5e046b |
| 2 | threshold=1.1、tilt=1、cadence=monthly | 0.0063 | 0.0043 | 0.0020 | 山脊 | 68 | run-5e256f3ce1111a78 |
| 3 | threshold=1.05、tilt=1、cadence=quarterly | 0.0041 | -0.0011 | 0.0053 | 孤峰 | 36 | run-afa9fe61298921be |
| 4 | threshold=1.1、tilt=1、cadence=quarterly | 0.0030 | 0.0023 | 0.0006 | 普通 | 30 | run-4a65c72ec4a06b8e |
| 5 | threshold=1.05、tilt=0.75、cadence=monthly | 0.0024 | 0.0001 | 0.0023 | 普通 | 560 | run-d80846c25c8bcfea |
...
|---|---|---|---|---|---|---|---|---|
| cadence=monthly | 15 | 15 | 2 | 0 | 1 | 0 | 0.0064 | -0.0021 |
...
- threshold=1.1、tilt=1、cadence=monthly:0.0063,連續軸鄰域平均 0.0043;換去最差那一層只有 0.0023(跌 0.0020)
...
- 交易成本:零(手續費與滑點皆為 0)
- 運行編號(30 個):`run-5ff372097a3d2ac6`、`run-cbd93db9a1835951`、`run-aeda1e9ed3ae9fae`、`run-43eb0410eec11f14`、`run-b1d9573c5d71b407`、`run-478e9f7a7988d53b`、`run-3a9786b7f82cb83a`、`run-eee1666b68fcbd0f`,另有 22 個
