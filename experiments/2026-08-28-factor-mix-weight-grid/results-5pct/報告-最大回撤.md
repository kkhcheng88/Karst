...
- 共 3542 格:平原 312 格、普通 3222 格、無效 8 格
- **單點最優**:weight_quality=0、weight_value=0、weight_momentum=0.05、weight_low_vol=0.95、cadence=monthly;max_drawdown = -0.3314,鄰域平均 -0.3324(落差 0.0010,平原),成交 280 筆,運行編號 run-f1db949aa847cc46
- **鄰域平均最高**:weight_quality=0、weight_value=0、weight_momentum=0.05、weight_low_vol=0.95、cadence=monthly;鄰域平均 -0.3324,本格 -0.3314(平原),運行編號 run-f1db949aa847cc46

### 頭 5 格(按 max_drawdown,只計有效格)

| # | 參數 | max_drawdown | 鄰域平均 | 落差 | 裁決 | 成交筆數 | 運行編號 |
|---|---|---|---|---|---|---|---|
| 1 | weight_quality=0、weight_value=0、weight_momentum=0.05、weight_low_vol=0.95、cadence=monthly | -0.3314 | -0.3324 | 0.0010 | 平原 | 280 | run-f1db949aa847cc46 |
| 2 | weight_quality=0.05、weight_value=0、weight_momentum=0、weight_low_vol=0.95、cadence=quarterly | -0.3314 | -0.3325 | 0.0010 | 平原 | 94 | run-653c919df2ddc50d |
| 3 | weight_quality=0、weight_value=0、weight_momentum=0.05、weight_low_vol=0.95、cadence=quarterly | -0.3314 | -0.3324 | 0.0010 | 平原 | 94 | run-40b43268cc754fa3 |
| 4 | weight_quality=0.05、weight_value=0、weight_momentum=0、weight_low_vol=0.95、cadence=monthly | -0.3314 | -0.3325 | 0.0010 | 平原 | 280 | run-a39b0f4105545319 |
| 5 | weight_quality=0、weight_value=0、weight_momentum=0.1、weight_low_vol=0.9、cadence=monthly | -0.3319 | -0.3327 | 0.0008 | 平原 | 280 | run-6a1989ab52838307 |

### 對照格

| 參數 | max_drawdown | 全格排名 | 運行編號 |
|---|---|---|---|
| weight_quality=0.25、weight_value=0.25、weight_momentum=0.25、weight_low_vol=0.25、cadence=monthly | -0.3499 | 2044 | run-bc650a4f67fceb9f |
| weight_quality=0.25、weight_value=0.25、weight_momentum=0.25、weight_low_vol=0.25、cadence=quarterly | -0.3493 | 1972 | run-5110658680fb21c8 |
