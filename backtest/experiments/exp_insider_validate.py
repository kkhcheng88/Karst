...
Sharpe / deflated Sharpe (honest re: how many variants were tried).
    ...
    python backtest/experiments/exp_insider_validate.py            # 2022q1..2025q2 default
"""
import io
import os
import sys
...
def _batch_prices(tickers, start=None):
    ...
    need = [t for t in syms if cache.get(t) is None]  # retry None-valued keys so a dead cache self-heals on a machine with a working price source
